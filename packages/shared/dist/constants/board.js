...
const prop = (i, name, group, price, rents, houseCost) => ({
    index: i,
...
const rr = (i, name, price) => ({ index: i, kind: TileKind.Railroad, name, price });
const util = (i, name, price) => ({ index: i, kind: TileKind.Utility, name, price });
const tax = (i, name, amount) => ({ index: i, kind: TileKind.Tax, name, amount });
const special = (i, kind, name) => ({ index: i, kind, name });
export const BOARD = [
